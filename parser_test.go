...
func TestParser_ParseStatement(t *testing.T) {
	...
	var tests = []struct {
		...
		{s: `SHOW FOO`, err: `found FOO, expected CONTINUOUS, DATABASE, DATABASES, DIAGNOSTICS, FIELD, GRANTS, MEASUREMENT, MEASUREMENTS, QUERIES, RETENTION, SERIES, SHARD, SHARDS, STATS, SUBSCRIPTIONS, TAG, USERS at line 1, char 6`},
		...
		{s: `DROP FOO`, err: `found FOO, expected CONTINUOUS, DATABASE, FIELD, MEASUREMENT, RETENTION, SERIES, SHARD, SUBSCRIPTION, USER at line 1, char 6`},
		...
		{s: `ALTER`, err: `found EOF, expected RETENTION, DATABASE, MEASUREMENT at line 1, char 7`},
